                  ...
                  <form method="post" action="register.php">
                      <?php include('errors.php'); ?>
                      	<div class="input-group">
                      	  ...
                      	  <input class="form-control" type="text" name="username" placeholder="הזן שם משתמש" size="35" style="padding: 2px 15px; direction: rtl;" require>
                      	</div>
                      	<div class="input-group">
                      	  <label>אימייל</label><br>
                      	  <input class="form-control" type="email" name="email" placeholder="הזן אימייל" size="35" style="padding: 2px 15px; direction: rtl;" require>
                      	</div>
                      	<div class="input-group">
                      	  <label>סיסמא</label><br>
                      	  <input class="form-control" type="password" placeholder="הזן סיסמא" size="35" style="padding: 2px 15px; direction: rtl;" require name="password_1">
                      	</div>
                      	<div class="input-group">
                      	  <label>אימות סיסמא</label><br>
                      	  <input class="form-control" type="password" placeholder="אימות הסיסמא" size="35" style="padding: 2px 15px; direction: rtl;" require name="password_2">
                      	</div>
                      	  	<div class="input-group">
                      	  <label>כתובת</label><br>
                      	  <input class="form-control" type="address" placeholder="הזן כתובת" size="35" style="padding: 2px 15px; direction: rtl;" required name="address">
                      	</div>
                      	  	<div class="input-group">
                      	  <label>טלפון</label><br>
                      	  <input class="form-control" type="tel" placeholder="הזן מס' טלפון" size="35" style="padding: 2px 15px; direction: rtl;" required name="tel">
                      	</div>
						<br>
                    
                      	<div class="input-group">
                      	  <button type="submit" class="b1" id="b2" name="reg_user"><span>הרשמה</span></button>
                      	</div>
                      	<p>
                      		אתה רשום? <a href="login.php">כניסה</a>
                      	</p>
